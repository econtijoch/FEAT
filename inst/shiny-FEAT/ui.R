    ...
    tabPanel("Transplant Metrics by OTU",
             ...
             fluidRow(
               column(6,
					  ...
					  br(),
                                uiOutput("N_Donor"),
								bsPopover('N_Donor', title = HTML(paste("N", tags$sub("Donor"), sep = "")), "The number of OTUs that are reliably and exclusively in the donor.", placement = 'right'),
								br(),
								uiOutput("N_Recipient"),
								bsPopover('N_Recipient', title = HTML(paste("N", tags$sub("Recipient"), sep = "")), "The number of OTUs that are reliably and exclusively in the recipient.", placement = 'right'),
								br(),
								uiOutput("N_P_Total"),
								bsPopover('N_P_Total', title = HTML(paste("N", tags$sub("Post-FMT"), sep = "")), "The number of OTUs that are reliably in the post-transplant samples (minus number that are unique to the post-transplant samples and the number that are shared throughout, if this is selected for).", placement = 'right'),
								br(),
								uiOutput("N_P_Unique"),
								...
								br(),
								uiOutput("N_P_Shared"),
								bsPopover('N_P_Shared', title = HTML(paste("N", tags$sub("Post-FMT (Shared)"), sep = "")), "Number of OTUs that are reliably present in both donor AND recipient samples throughout.", placement = 'right'),
								br(),
		   					 uiOutput("N_P_Donor"),
		   					 bsPopover("N_P_Donor", title = HTML(paste("N", tags$sub("Donor | Post-FMT"), sep = "")), content = "The number of OTUs in the post-transplant samples that came from the donor.", placement = 'right'),
							 br(),
					 uiOutput("N_P_Recipient"),
					 bsPopover("N_P_Recipient", title = HTML(paste("N", tags$sub("Recipient | Post-FMT"), sep = "")), content = "The number of OTUs in the post-transplant samples that came from the recipient.", placement = 'right')
								)),
				column(6, 
					 wellPanel(style = 'overflow:hidden;background-color:white',
					 h4("FMT Metrics"),
					 br(),
					 uiOutput("D_Engraft"),
					 bsPopover('D_Engraft', title = HTML(paste("D", tags$sub("Engraft"), sep = "")), content = HTML(paste("The proportion of the donor microbiota that engrafts into the recipient.", tags$img(src= 'D-engraft.png'), sep = "")), placement = 'right'),
					 br(),
					 uiOutput("R_Persist"),
					 bsPopover('R_Persist', title = HTML(paste("R", tags$sub("Persist"), sep = "")), content = HTML(paste("The proportion of the recipient microbiota that persists after the transplant.", tags$img(src = 'R-persist.png'), sep = "")), placement = 'right'),					 
					 br(),
					 uiOutput("P_Donor"),
					 bsPopover("P_Donor", title = HTML(paste("P", tags$sub("Donor"), sep = "")), content = HTML(paste("The proportion of OTUs in the post-transplant samples that is derived from the donor.", tags$img(src = 'P-donor.png'), sep = "")), placement = 'right'),
					 br(),
					 uiOutput("P_Recipient"),
					 bsPopover("P_Recipient", title = HTML(paste("P", tags$sub("Recipient"), sep = "")), content = HTML(paste("The proportion of OTUs in the post-transplant samples that is derived from the recipient.", tags$img(src = 'P-recipient.png'), sep = "")), placement = 'right'),
					 br(),
					 uiOutput("P_Unique"),
					 bsPopover("P_Unique", title = HTML(paste("P", tags$sub("Unique"), sep = "")), content = HTML(paste("The proportion of OTUs in the post-transplant samples that are neither in the donor NOR in the recipient.", tags$img(src = 'P-unique.png'), sep = "")), placement = 'right'),
					 br(),
					 uiOutput("P_Shared"),
					 bsPopover("P_Shared", title = HTML(paste("P", tags$sub("Shared"), sep = "")), content = HTML(paste("The proportion of OTUs in the post-transplant samples that are shared in both the donor AND the recipient.", tags$img(src = 'P-shared.png'), sep = ""))), placement = 'right'))
             ),
             hr(),
