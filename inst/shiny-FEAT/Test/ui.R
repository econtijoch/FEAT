...
shinyUI(
  navbarPage(
    ...
    tabPanel(
      ...
      h3("Description"),
      p(
        "This tool is designed to help quickly and interactively analyze microbiome sequencing data from FMT experiments. The two main inputs that you need are an OTU table and a mapping file."
      ),
      h3("Inputs"),
      p(
        strong("OTU Table:"),
                             ...
                             fluidRow(
                               ...
                               column(
                                 ...
                                 selectInput(
                                   ...
                                   choices = c("Work with Taxonomy" = TRUE,
