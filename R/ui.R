             ...
             fluidRow(column(6,
                             ...
                             conditionalPanel(condition = "output.zeroeth_check == 'Table loaded successfully...'",
                                              wellPanel(h3("2) Select FMT Samples"),
                                                        ...
                                                        hr(),
                                                        uiOutput("post_fmt"),
                                                        actionButton("split_into_experiment", "Set FMT Details"),
                                                        hr(),
                      ...
                      column(6,
                             conditionalPanel(condition = "output.second_check == 'Experiment-specific table created...'",
                                              wellPanel(h3("3) Normalize and Filter Samples"),
                                                        ...
                                                        actionButton("normalize_filter", "Normalize and Filter by relative abundance"),
                                                        hr(),
             ...
             fluidRow(
               ...
               column(4,
                      wellPanel(style = 'overflow:hidden;',
                                ...
                                h4(textOutput("num_otus_post_fmt_selected")))),
               column(2,
                      wellPanel(style = 'overflow:hidden;',
                                ...
                                h4(textOutput("num_otus_unique_post_fmt")))),
               column(2,
                      wellPanel(style = 'overflow:hidden;',
                                ...
                                h4(textOutput("num_otus_shared_throughout"))))
             ),
             hr(),
             h4("Donor Metrics"),
             fluidRow(
